        ...
        if (__$t === "menu") {
            ...
            if (!$$elem && (__$ctx.__$a0 & 32) === 0) {
                ...
                __$ctx.ctx = {
                    ...
                    mix: {
                        block: "autocomplete",
                        js: __$ctx.ctx.js || true
                    },
                    mods: {
                        target: "anchor",
                        theme: "islands"
                    },
                    directions: __$ctx.ctx.directions,
                    content: {
                        block: "menu",
                        mods: {
                            size: "xl",
...
function __$b3(__$ctx, __$ref) {
    ...
    return {
        mainOffset: ctx__$19.mainOffset,
        secondaryOffset: ctx__$19.secondaryOffset,
        viewportOffset: ctx__$19.viewportOffset,
        directions: ctx__$19.directions,
        zIndexGroupLevel: ctx__$19.zIndexGroupLevel
    };
}
...
function __$b8(__$ctx, __$ref) {
    ...
    $$mods.disabled || (attrs__$3.tabindex = 0);
    return attrs__$3;
}

function __$b14(__$ctx, __$ref) {
    var ctx__$4 = __$ctx.ctx, mods__$5 = $$mods, firstItem__$6, checkedItems__$7 = [];
    if (ctx__$4.content) {
        var isValDef__$8 = typeof ctx__$4.val !== "undefined", containsVal__$9 = function(val) {
            return isValDef__$8 && (mods__$5.mode === "check" ? ctx__$4.val.indexOf(val) > -1 : ctx__$4.val === val);
        }, iterateItems__$10 = function(content) {
            var i__$11 = 0, itemOrGroup__$12;
            while (itemOrGroup__$12 = content[i__$11++]) {
                if (itemOrGroup__$12.block === "menu-item") {
                    firstItem__$6 || (firstItem__$6 = itemOrGroup__$12);
                    if (containsVal__$9(itemOrGroup__$12.val)) {
                        (itemOrGroup__$12.mods = itemOrGroup__$12.mods || {}).checked = true;
                        checkedItems__$7.push(itemOrGroup__$12);
                    }
                } else {
                    iterateItems__$10(itemOrGroup__$12.content);
                }
            }
        };
        iterateItems__$10(ctx__$4.content);
    }
    __$ctx._firstItem = firstItem__$6;
    __$ctx._checkedItems = checkedItems__$7;
    var __$r__$14;
    var __$l0__$15 = __$ctx._menuMods;
    __$ctx._menuMods = {
        theme: mods__$5.theme,
        disabled: mods__$5.disabled
    };
    var __$r__$17;
...
/* begin: ../../common.blocks/dictionary/dictionary.vanilla.js */
/** @class dictionary */
modules.define('dictionary', function(provide) {
    provide([
        { words : ['be', 'was/were', 'been'] },
        { words : ['Light', 'lit', 'lit'] },
        { words : ['beat', 'beat', 'beaten'] },
        { words : ['lose', 'lost', 'lost'] },
        { words : ['become', 'became', 'become'] },
        { words : ['make', 'made', 'made'] },
        { words : ['begin', 'began', 'begun'] },
        { words : ['mean', 'meant', 'meant'] },
        { words : ['bend', 'bent', 'bent'] },
        { words : ['meet', 'met', 'met'] },
        { words : ['bet', 'bet', 'bet'] },
        { words : ['pay', 'paid', 'paid'] },
        { words : ['bite', 'bit', 'bitten'] },
        { words : ['put', 'put', 'put'] },
        { words : ['blow', 'blew', 'blown'] },
        { words : ['read', 'read', 'read'] },
        { words : ['break', 'broke', 'broken'] },
        { words : ['ride', 'rode', 'ridden'] },
        { words : ['bring', 'brought', 'brought'] },
        { words : ['ring', 'rang', 'rung'] },
        { words : ['broadcast', 'broadcast', 'broadcast'] },
        { words : ['rise', 'rose', 'risen'] },
        { words : ['build', 'built', 'built'] },
        { words : ['run', 'ran', 'run'] },
        { words : ['burst', 'burst', 'burst'] },
        { words : ['say', 'said', 'said'] },
        { words : ['buy', 'bought', 'bought'] },
        { words : ['see', 'saw', 'seen'] },
        { words : ['catch', 'caught', 'caught'] },
        { words : ['seek', 'sought', 'sought'] },
        { words : ['choose', 'chose', 'chosen'] },
        { words : ['sell', 'sold', 'sold'] },
        { words : ['come', 'came', 'come'] },
        { words : ['send', 'sent', 'sent'] },
        { words : ['cost', 'cost', 'cost'] },
        { words : ['set', 'set', 'set'] },
        { words : ['creep', 'crept', 'crept'] },
        { words : ['sew', 'sewed', 'sewn/sewed'] },
        { words : ['cut', 'cut', 'cut'] },
        { words : ['shake', 'shook', 'shaken'] },
        { words : ['deal', 'dealt', 'dealt'] },
        { words : ['shine', 'shone', 'shone'] },
        { words : ['dig', 'dug', 'dug'] },
        { words : ['shoot', 'shot', 'shot'] },
        { words : ['do', 'did', 'done'] },
        { words : ['show', 'showed', 'shown/showed'] },
        { words : ['draw', 'drew', 'drawn'] },
        { words : ['shrink', 'shrank', 'shrunk'] },
        { words : ['drink', 'drank', 'drunk'] },
        { words : ['shut', 'shut', 'shut'] },
        { words : ['drive', 'drove', 'driven'] },
        { words : ['sing', 'sang', 'sung'] },
        { words : ['eat', 'ate', 'eaten'] },
        { words : ['sink', 'sank', 'sunk'] },
        { words : ['fall', 'fell', 'fallen'] },
        { words : ['sit', 'sat', 'sat'] },
        { words : ['feed', 'fed', 'fed'] },
        { words : ['sleep', 'slept', 'slept'] },
        { words : ['feel', 'felt', 'felt'] },
        { words : ['slide', 'slid', 'slid'] },
        { words : ['fight', 'fought', 'fought'] },
        { words : ['speak', 'spoke', 'spoken'] },
        { words : ['find', 'found', 'found'] },
        { words : ['spend', 'spent', 'spent'] },
        { words : ['flee', 'fled', 'fled'] },
        { words : ['spit', 'spat', 'spat'] },
        { words : ['fly', 'flew', 'flown'] },
        { words : ['split', 'split', 'split'] },
        { words : ['forbid', 'forbade', 'forbidden'] },
        { words : ['spread', 'spread', 'spread'] },
        { words : ['forget', 'forgot', 'forgotten'] },
        { words : ['spring', 'sprang', 'sprung'] },
        { words : ['forgive', 'forgave', 'forgiven'] },
        { words : ['stand', 'stood', 'stood'] },
        { words : ['freeze', 'froze', 'frozen'] },
        { words : ['steal', 'stole', 'stolen'] },
        { words : ['get', 'got', 'got/gotten'] },
        { words : ['stick', 'stuck', 'stuck'] },
        { words : ['give', 'gave', 'given'] },
        { words : ['sting', 'stung', 'stung'] },
        { words : ['go', 'went', 'gone'] },
        { words : ['stink', 'stank', 'stunk'] },
        { words : ['grow', 'grew', 'grown'] },
        { words : ['strike', 'struck', 'struck'] },
        { words : ['hang', 'hung', 'hung'] },
        { words : ['swear', 'swore', 'sworn'] },
        { words : ['have', 'had', 'had'] },
        { words : ['sweep', 'swept', 'swept'] },
        { words : ['hear', 'heard', 'heard'] },
        { words : ['swim', 'swam', 'swum'] },
        { words : ['hide', 'hid', 'hidden'] },
        { words : ['swing', 'swung', 'swung'] },
        { words : ['hit', 'hit', 'hit'] },
        { words : ['take', 'took', 'taken'] },
        { words : ['hold', 'held', 'held'] },
        { words : ['teach', 'taught', 'taught'] },
        { words : ['hurt', 'hurt', 'hurt'] },
        { words : ['tear', 'tore', 'torn'] },
        { words : ['keep', 'kept', 'kept'] },
        { words : ['tell', 'told', 'told'] },
        { words : ['kneel', 'knelt', 'knelt'] },
        { words : ['think', 'thought', 'thought'] },
        { words : ['know', 'knew', 'known'] },
        { words : ['throw', 'threw', 'thrown'] },
        { words : ['Lay', 'laid', 'laid'] },
        { words : ['understand', 'understood', 'understood'] },
        { words : ['Lead', 'led', 'led'] },
        { words : ['wake', 'woke', 'woken'] },
        { words : ['Leave', 'left', 'left'] },
        { words : ['wear', 'wore', 'worn'] },
        { words : ['Lend', 'lent', 'lent'] },
        { words : ['weep', 'wept', 'wept'] },
        { words : ['Let', 'let', 'let'] },
        { words : ['win', 'won', 'won'] },
        { words : ['Lie', 'lay', 'lain'] },
        { words : ['write', 'wrote', 'written'] }
    ]);
});

/* end: ../../common.blocks/dictionary/dictionary.vanilla.js */
...
/* begin: ../../common.blocks/dictionary/dictionary.browser.js */
/** @class dictionary */
modules.define('dictionary', ['i-bem__dom', 'jquery'], function(provide, BEMDOM, $, block) {
    provide(BEMDOM.decl(this.name, /** @lends dictionary.prototype */{
        onSetMod : {
            js : {
                inited : function() {
                    var _this = this;

                    this._search = this.findBlockInside('input');
                    // TODO: см ниже проблему с ие
                    this._search.setVal('');

                    this._rows = Array.prototype.reduce.call(this.domElem.find('table tr'),
                        function(prev, value) {
                            if(value.children[0].tagName.toLowerCase() !== 'td') return prev;
                            prev[$(value.children[0]).text()] = $(value);
                            return prev;
                        }, {});

                    this._words = Object.keys(this._rows);
                    console.log(2);

                    this._search.on('change', function(e) {
                        console.log(1);
                        var visibleSet = _this._words.filter(function(value) {
                            return value.indexOf(_this._search.getVal()) === 0;
                        });

                        _this._words.forEach(function(key) {
                            visibleSet.indexOf(key) > -1 ?
                                _this._rows[key].removeClass('hidden') :
                                _this._rows[key].addClass('hidden');
                        });
                    });
                }
            }
...
//                console.log(1);
//                var visibleSet = this._words.filter(function(value) {
//                    return value.indexOf(this._search.getVal()) === 0;
//                }, this);
//
//                this._words.forEach(function(key) {
//                    visibleSet.indexOf(key) > -1 ?
//                        this._rows[key].removeClass('hidden') :
//                        this._rows[key].addClass('hidden');
//                }, this);
//            });

            // TODO: ie кэширует value полей ввода, придется пока сразу инициализировать блок и явно чистить поля
            return false;
        },
...
/* end: ../../common.blocks/dictionary/dictionary.browser.js */
/* begin: ../../common.blocks/play/play.browser.js */
/** @class play */
modules.define('play', ['i-bem__dom', 'BEMHTML', 'jquery'], function(provide, BEMDOM, BEMHTML, $) {
    provide(BEMDOM.decl(this.name, /** @lends play.prototype */{
        onSetMod : {
            js : {
                inited : function() {
                    var text = this.params.text;

                    this._audioBlock = $(BEMHTML.apply({
                        block : 'audio',
                        tag : 'audio',
                        content : [
                            {
                                tag : 'source',
                                attrs : { src : this.__self.getAudioSource(text, 'mp3'), type : 'audio/mpeg3' }
                            },
                            {
                                tag : 'source',
                                attrs : { src : this.__self.getAudioSource(text, 'wav'), type : 'audio/wav' }
                            }
                        ]
                    })).bem('audio');
                    this._audio = this._audioBlock.domElem.get(0);

                    BEMDOM.append(this.domElem, this._audioBlock.domElem);
                }
            }
        }
    }, /** @lends play */{
        live : function() {
            this.liveBindTo('click', function() {
                // TODO: каждый раз дергается источник данных. В ff все ок, можно без load, он кэширует и позволяет
                // заново воспроизводить по play. audio.currentTime = 0 не работает с отличным доменом источника
                // (см. stackoverflow)
                this._audio.load();
                this._audio.play();
            });
        ...
        getAudioSource : function(text, format) {
            return 'http://tts.voicetech.yandex.net/tts?format=' + format +
                '&quality=hi&platform=web&application=slovari&text=' + text + '&lang=en_GB';
        }
    }));
});

/* end: ../../common.blocks/play/play.browser.js */
/* begin: ../../common.blocks/test/test.browser.js */
/** @class test */
modules.define('test', [
    'i-bem__dom', 'BEMHTML', 'jquery', 'dictionary'
], function(provide, BEMDOM, BEMHTML, $, dictionary) {
    ...
    var Test = function(data, mode) {
        this._mode = mode;
        this._data = shuffle(data.slice());
        this._nLeft = this._nTotal = this._data.length;
    };

    Test.prototype._nAsk = 0;
    Test.prototype._nCorrect = 0;
    Test.prototype._nTotal = 0;
    Test.prototype._nLeft = 0;

    Test.prototype.getProgress = function() {
        return (this._nTotal - this._nLeft) + '/' + this._nTotal;
    };

    Test.prototype.getResult = function() {
        if(this.result) return this.result;

        var time = (this._tsStop || new Date()) - this._tsStart,
            seconds = Math.ceil(time / 1000 % 60),
            minutes = Math.floor(time / 60000),
            percentage = this._nCorrect * 100 / this._nAsk;
        ...
        this.result = {
            ...
            nAsk : this._nAsk,
            nCorrect : this._nCorrect,
            percentage : percentage,
            percentageHuman : percentage.toFixed(2) + '%'
        };

        return this.result;
    }

    Test.prototype.check = function(answer) {
        var result = this._data[0].answer.every(function(value, index) { return value === answer[index]; }),
            correctAnswer = this._data[0].answer;

        if(this._mode !== 'learn' || result) {
            correctAnswer = this._data.shift().answer;
            this._nLeft -= 1;
        }

        if(result) this._nCorrect += 1;
        else if(this._mode === 'learn') shuffle(this._data);

        return result || correctAnswer;
    };

    Test.prototype.getNext = function() {
        if(this._data.length) this._nAsk += 1;

        return this._data[0] && this._data[0].question;
    };

    Test.prototype.start = function() {
        this._tsStart = new Date();

        return this;
    }

    Test.prototype.stop = function() {
        this._tsStop = new Date();

        return this;
    }

    provide(BEMDOM.decl(this.name, /** @lends test.prototype */{
        onSetMod : {
            js : {
                inited : function() {
                    var _this = this;

                    this._checkBtn = this.findBlockInside(this.elem('checkBtn'), 'button');
                    this._inputs = this.findBlocksOn(this.elem('answer'), 'input');
                    this._mode = this.findBlockOn(this.elem('mode'), 'radio-group');
                    this._popups = this._inputs.map(function(input) {
                       var popup = $(BEMHTML.apply({
                        ...
                        BEMDOM.append(this.domElem, popup.domElem);
                    ...
                    this._autocomplete = $(BEMHTML.apply({
                        block : 'autocomplete',
                        directions : ['bottom-left', 'bottom-center', 'bottom-right']
                    })).bem('autocomplete');

                    this._autocomplete.setData(this._getData().reduce(function(prev, value) {
                        return prev.concat(value.answer);
                    }, []).filter(function(value, index, array) {
                            // удалить дубликаты
                            return array.indexOf(value) === index;
                        }).sort());

                    BEMDOM.append(_this.domElem, this._autocomplete.domElem);
                    this._autocomplete.setAnchor(this._inputs);

                    this._autocomplete.on('select', function() {
                        _this._inputs.some(function(input, index, array) {
                            var isFocused = input.hasMod('focused');
                            if(isFocused) if(array[index + 1]) array[index + 1].setMod('focused', true);
                            else _this._checkBtn.setMod('focused', true);
                            return isFocused;
                        });
                    });

                    this._checkBtn.on('click', function() {
                        _this._check(_this._getAnswer());
                    });

                    this.bindTo('keyup', function(e) {
                        if(e.ctrlKey && e.keyCode === 13) _this._check(_this._getAnswer());
                    });
                }
            },
            ...
            started : {
                true : function() {
                    this.delMod('finished');

                    this.test = new Test(this._getData(), this._mode.getVal());
            ...
            disabled : function(modName, modVal) {
                this._inputs.forEach(function(input) { input.setMod('disabled', modVal); });
                this._checkBtn.setMod('disabled', modVal);
            },
            ...
            finished : {
                true : function() {
                    ...
                    this.elem('result').html([
                        '<b>Результат</b><br>',
                        'Правильных ответов: ' + result.percentageHuman +
                            ' (' + result.nCorrect + ' из ' + result.nAsk + ')',
                        'Затрачено времени: ' + result.timeHuman
                    ].join('<br>'));
                }
            }
        },
        ...
        _ask : function() {
            var word = this.test.getNext();

            if(!word) return this.setMod('finished', true);

            this.elem('progress').text(' (пройдено ' + this.test.getProgress() + ')');
            this.elem('question').text(word);
            this._inputs[0].elem('control').focus();
        },
        ...
        _check : function(result) {
            ...
            var _this = this,
                answer = this.test.check(result),
                delay = 0;

            if(answer !== true) {
                this.setMod('disabled', true);
                this._showErrors(answer);
        ...
        _getAnswer : function() {
            return this._inputs.map(function(input) { return input.getVal().toLowerCase(); });
        },
        ...
        _getData : function() {
            ...
            this._data = dictionary.dictionary.map(function(word) {
                return {
                    answer : word.words.slice(1).map(function(value) {
                        return value.toLowerCase();
                    }),
                    question : word.words[0].toLowerCase()
                };
            });
        ...
        _showErrors : function(answer) {
            var userAnswer = this._getAnswer();

            this._autocomplete.close();

            answer.forEach(function(value, index) {
                this._highlightInput(this._inputs[index], value === userAnswer[index], value);
            }, this);
        },

        _highlightInput : function(input, isCorrect, answer) {
            if(isCorrect === undefined) {
                input.delMod('highlight');
                this._popups.forEach(function(popup) { popup.delMod('visible'); });

                return;
            }

            input.setMod('highlight', isCorrect ? 'ok' : 'error');
            !isCorrect && this._popups[this._inputs.indexOf(input)].setMod('visible', true).setContent(answer);
        }
    }, /** @lends test */{
        live : function() {
            this.liveBindTo('startBtn', 'click', function() {
                if(!this.hasMod('started')) this.setMod('started', true);
            });

            this.liveBindTo('finishBtn', 'click', function() {
                if(this.hasMod('started')) this.setMod('finished', true);
            });
        }
    }));
});

/* end: ../../common.blocks/test/test.browser.js */
/* begin: ../../common.blocks/autocomplete/autocomplete.browser.js */
/** @class autocomplete */
modules.define('autocomplete', [
    'i-bem__dom', 'BEMHTML', 'jquery', 'functions__throttle'
    ...
    provide(BEMDOM.decl(this.name, /** @lends autocomplete.prototype */{
        onSetMod : {
            js : {
                inited : function() {
                    ...
                    this._menu.on('item-click', function(e, data) {
                        _this._selectItem(data.item);
                    });
                }
            }
        },
        ...
        _selectItem : function(item) {
            if(!item) return;
            if(this._targetInput) this._targetInput.setVal(item.getVal(), {
        ...
        _update : function() {
            ...
            var search = this._findItemsByText(this._targetInput.getVal()).slice(0, this._items.length);

            search.forEach(function(item, index) {
                this._items[index].params.val = item.val;
                this._items[index].domElem.html(item.text);
            }, this);

            this._visibleItems = this._items.slice(0, search.length);
            this._items.forEach(function(item) {
                item.setMod('hidden', this._visibleItems.indexOf(item) === -1 || '');
            }, this);
            this._visibleItems.length && this._hoverItem(this._visibleItems[0]);

            return this;
        },

        /**
         * Находит подходящие варианты по переданному значению
         * @param {*} query
         * @returns {Array<BEM>} Возвращает массив блоков menu-item
         * @private
         */
        _findItemsByText : function(query) {
            // TODO: wtf?  \ -> [\] - match all
            var re = new RegExp('^([\\s\\S]*?)([' + query.split('').join('])([\\s\\S]*?)([') + '])([\\s\\S]*?)$', 'i'),
                items = [];

            this._data.forEach(function(string) {
        ...
        _needToOpen : function() {
            return this._targetInput && this._visibleItems.length && this._targetInput.getVal().length &&
                !(this._visibleItems.length === 1 && this._visibleItems[0].getVal() === this._targetInput.getVal());
        },
         ...
         * @param {Array<BEM>} inputs Массив блоков input
         * @returns {this}
         */
        ...
        setAnchor : function(inputs) {
            ...
            inputs.forEach(function(input) {
                input.on('change', throttle(function(e, data) {
                ...
                input.bindTo(input.elem('control'), 'blur focus keydown', function(e) {
                    if(e.type === 'blur') _this.close();
                    if(e.type === 'focus') {
                        _this._targetInput = input;
                        _this._popup.setAnchor(input);

                        _this._update();
                        _this._needToOpen() && _this.open();
                    }
                    if(e.type === 'keydown' && [13, 35, 36, 38, 40].indexOf(e.keyCode) !== -1) {
                        var hoveredIndex = _this._visibleItems.indexOf(_this._menu._hoveredItem);

                        // не двигать курсор в инпуте по нажатию home/end
                        e.preventDefault();

                        switch(e.keyCode) {
                            // enter
                            case 13 : _this._selectItem(_this._menu._hoveredItem); break;
                            // end
                            case 35 : _this._hoverItem(_this._visibleItems[_this._visibleItems.length - 1]); break;
                            // home
                            case 36 : _this._hoverItem(_this._visibleItems[0]); break;
                            // arrow up
                            case 38 : {
...
/* end: ../../common.blocks/autocomplete/autocomplete.browser.js */